...
const MOCK_BOOKS = [
  {
    ...
    author: 'TURYAHIKAYO EVEREST', // <-- EDIT THIS
    ...
    links: [
      { name: `Universal D2D Link (Covers ${D2D_RETAILERS_LIST})`, url: 'https://books2read.com/u/bpPM5q' }, // *** EDIT THIS URL ***
    ],
  ...
  },
  {
    ...
    links: [
      { name: `Universal D2D Link (Covers ${D2D_RETAILERS_LIST})`, url: 'https://books2read.com/u/3GQ7YO' }, // *** EDIT THIS URL ***
    ],
  ...
  },
  {
    ...
    links: [
      { name: `Universal D2D Link (Covers ${D2D_RETAILERS_LIST})`, url: 'https://books2read.com/u/4ADpZJ' }, // *** EDIT THIS URL ***
    ],
  ...
  },
  {
    ...
    links: [
      { name: `Universal D2D Link (Covers ${D2D_RETAILERS_LIST})`, url: 'https://books2read.com/u/mqLMd1' }, // *** EDIT THIS URL ***
    ],
  ...
  },
  {
    ...
    links: [
      { name: `Universal D2D Link (Covers ${D2D_RETAILERS_LIST})`, url: 'https://books2read.com/u/3RvYXY' }, // *** EDIT THIS URL ***
    ],
    coverPlaceholder: 'https://placehold.co/300x450/2563eb/ffffff?text=Por+que+Se+Sale'
  },
];

// --- Constants (Code Below Handles Reviews and UI Logic) ---
